import{s as a}from"./mobile-version-de24c2cd.js";const g="favorite-articles";document.addEventListener("DOMContentLoaded",e=>{e.preventDefault(),document.querySelector(".articles_container").innerHTML=f()});function f(){const e=JSON.parse(localStorage.getItem(g));return!e||e.length===0?"<li class='not-found-container'><h2 class='articles-not-found'>You don't have favorite articles yet</h2><img class='not-found-img' src='./images/not-found-desktop-1x.png' alt='no articles there'></li>":e.map(t=>{if(!t)return;const{section:n,title:c,description:o,url:d,date:u,img:h,imgCaption:p,id:_}=t;return`<li class="article" data-id="${_}">
     <div class="article_img_wrapper">
       <p class="already-read is-hidden">Already read</p>
       <p class="article_category">${n}</p>
       <img class="article_img" src="${h}" alt="${p}" width="395" height="395">
