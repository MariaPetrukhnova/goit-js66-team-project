import{s as r}from"./localeStoreageHandler-3f7907a1.js";function g(a,i=!0){return(i?m(a):a).map(e=>{if(!e)return;const{section:s,title:d,description:c,url:n,date:o,img:l,imgCaption:p,id:u}=e;return`<li class="article" data-id="${u}">
