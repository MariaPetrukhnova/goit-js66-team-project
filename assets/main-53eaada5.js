import{s as tn}from"./localeStoreageHandler-0a11065a.js";import{c as Xc}from"./markup-a0d6cb7e.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yu=1e3,bu=2,vu=4*60*60*1e3,wu=.5;function xr(n,e=yu,t=bu){const i=e*Math.pow(t,n),s=Math.round(wu*i*(Math.random()-.5)*2);return Math.min(vu,i+s)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yd="firebase-heartbeat-database",bd=1,sn="firebase-heartbeat-store";let Ii=null;function aa(){return Ii||(Ii=ra(yd,bd,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(sn)}}}).catch(n=>{throw Je.create("idb-open",{originalErrorMessage:n.message})})),Ii}async function vd(n){try{return(await aa()).transaction(sn).objectStore(sn).get(la(n))}catch(e){if(e instanceof De)ct.warn(e.message);else{const t=Je.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ct.warn(t.message)}}}async function Sr(n,e){try{const i=(await aa()).transaction(sn,"readwrite");return await i.objectStore(sn).put(e,la(n)),i.done}catch(t){if(t instanceof De)ct.warn(t.message);else{const i=Je.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});ct.warn(i.message)}}}function la(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ii{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(s=>s.isListeningto(e));if(t)return t;const i=new ii(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:i,eventType:s,data:r}=t.data,o=this.handlersMap[s];if(!(o!=null&&o.size))return;t.ports[0].postMessage({status:"ack",eventId:i,eventType:s});const a=Array.from(o).map(async c=>c(t.origin,r)),l=await vh(a);t.ports[0].postMessage({status:"done",eventId:i,eventType:s,response:l})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}ii.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jf{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&vn(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vp{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&be(this.last_,(i,s)=>{t[i]=t[i]-s}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let wo;function Im(n){g(!wo,"__referenceConstructor has already been defined"),wo=n}function js(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return g(r!=null,"SyncTree gave us an op for an invalid query."),vo(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(vo(o,e,t,i));return r}}function qs(n,e){let t=null;for(const i of n.views.values())t=t||xm(i,e);return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xo;function Cm(n){g(!xo,"__referenceConstructor has already been defined"),xo=n}class ko{constructor(e){this.listenProvider_=e,this.syncPointTree_=new z(null),this.pendingWriteTree_=dm(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Em(n,e,t,i,s){return em(n.pendingWriteTree_,e,t,i,s),s?ai(n,new pt(yl(),e,t)):[]}function Ct(n,e,t=!1){const i=tm(n.pendingWriteTree_,e);if(nm(n.pendingWriteTree_,e)){let r=new z(null);return i.snap!=null?r=r.set(F(),!0):be(i.children,o=>{r=r.set(new H(o),!0)}),ai(n,new Kn(i.path,r,t))}else return[]}function oi(n,e,t){return ai(n,new pt(bl(),e,t))}function Sm(n,e,t){const i=z.fromObject(t);return ai(n,new cn(bl(),e,i))}function Tm(n,e,t,i){const s=Ll(n,i);if(s!=null){const r=Pl(s),o=r.path,a=r.queryId,l=ge(o,e),c=new pt(vl(a),l,t);return Fl(n,o,c)}else return[]}function Nm(n,e,t,i){const s=Ll(n,i);if(s){const r=Pl(s),o=r.path,a=r.queryId,l=ge(o,e),c=z.fromObject(t),h=new cn(vl(a),l,c);return Fl(n,o,h)}else return[]}function Ol(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=ge(o,e),c=qs(a,l);if(c)return c});return El(s,e,r,t,!0)}function ai(n,e){return Dl(e,n.syncPointTree_,null,Il(n.pendingWriteTree_,F()))}function Dl(n,e,t,i){if(T(n.path))return Ml(n,e,t,i);{const s=e.get(F());t==null&&s!=null&&(t=qs(s,F()));let r=[];const o=N(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,h=Tl(i,o);r=r.concat(Dl(a,l,c,h))}return s&&(r=r.concat(js(s,n,i,t))),r}}function Ml(n,e,t,i){const s=e.get(F());t==null&&s!=null&&(t=qs(s,F()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=Tl(i,o),h=n.operationForChild(o);h&&(r=r.concat(Ml(h,a,l,c)))}),s&&(r=r.concat(js(s,n,i,t))),r}function Ll(n,e){return n.tagToQueryMap.get(e)}function Pl(n){const e=n.indexOf("$");return g(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new H(n.substr(0,e))}}function Fl(n,e,t){const i=n.syncPointTree_.get(e);g(i,"Missing sync point for query tag that we're tracking");const s=Il(n.pendingWriteTree_,e);return js(i,t,s,null)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $m{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function jm(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!ul(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function vt(n,e,t){jm(n,t),qm(n,i=>ke(i,e)||ke(e,i))}function qm(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(Vm(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Vm(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();lt&&se("event: "+t.toString()),vn(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
