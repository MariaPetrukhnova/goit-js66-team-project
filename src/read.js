...
import {
  ...
  setFavorites,
  setRead,
} from './partials/localeStoreageHandler';
...
function makeMarkup() {
  ...
  articles.forEach(article => {
    ...
    const formatDate = `${String(articleDate.getDate()).padStart(
      2,
      '0'
    )}/${String(articleDate.getMonth() + 1).padStart(
      2,
      '0'
